...
import { createMarkup, getCountries } from "../../screens/dashboards";
          ...
          >
            ...
            <div className="flex justify-end">
              {!start && (
                <button
                  type="button"
                  className="w-[25px] h-[25px] flex justify-center items-center text-xl font-bold bg-[#D2D7D4]"
                >
              ...
              {start && (
                <>
                  {product?.status === "good" ? (
                    <button
                      type="button"
                      className="w-[25px] h-[25px] flex justify-center items-center text-xl font-bold bg-[#BAFED2]"
                    >
                    ...
                    <button
                      type="button"
                      className="w-[25px] h-[25px] flex justify-center items-center text-xl font-bold bg-[#EF444433]"
                    >
