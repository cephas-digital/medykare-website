...
const DoctorAppointmentsPage: React.FC = () => {
  ...
  const handleViewAppointment = (patientId: string) => {
    navigate(`/doctor/appointments/${patientId}`);
  };
...
//                     </td>
//                     <td className="px-6 py-4">
//                       <button className="text-[#4F7396] font-bold text-sm font-Outfit hover:underline">
//                         View
//                       </button>
//                     </td>
//                   </tr>
